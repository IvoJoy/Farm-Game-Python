'''the module for the soil and farming'''
import os
...
class Plant(pygame.sprite.Sprite):
    ...
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(os.getcwd() + f'/graphics/fruit/{plant_type}')
        self.soil = soil
...
class SoilLayer:
    ...
    def __init__(self, all_sprites, collision_sprites):
        ...
        self.water_surfs = import_folder(os.getcwd() + '/graphics/soil_water/')
        self.create_soil_grid()
        self.create_hit_rects()
        # sounds
        self.hoe_sound = pygame.mixer.Sound(os.getcwd() + '/audio/hoe.wav')
        self.hoe_sound.set_volume(0.1)
        self.plant_sound = pygame.mixer.Sound(os.getcwd() + '/audio/plant.wav')
        self.plant_sound.set_volume(0.2)

    def create_soil_grid(self):
        '''creating the soil grid'''
        ground = pygame.image.load(os.getcwd() + '/graphics/world/ground.png')
